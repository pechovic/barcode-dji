package barcode.barclays.com.drone.common;
...
public class DJIBarcodeApplication extends Application {

    private static final String TAG = DJIBarcodeApplication.class.getName();
